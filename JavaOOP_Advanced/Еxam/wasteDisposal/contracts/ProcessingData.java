...
public interface ProcessingData {
    ...
    /**
     * Getter function returning the EnergyBalance, a positive number means the process produced energy, while a
     * negative
    ...
    /**
     * Getter function returning the CapitalBalance, a positive number means the process produced capital, while a
     * negative
